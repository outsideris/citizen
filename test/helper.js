  ...
  enableMock: ({ modulePath }) => {
    if (process.env.CITIZEN_MOCK_ENABLED) {
      nock('https://s3.amazonaws.com')
        ...
        .reply(
          ...
          [
            ...
            '66E7A19ACCD7B823',
            'x-amz-id-2',
            'GWudIHA65prhHIpG5drFq6BG0fQsB5nKTnYtLFl0UZ/6MBrAwOJQdRzEDj88kSNmDCGFgzE3Y+c=',
            'Content-Type',
            'application/xml',
            'Transfer-Encoding',
            'chunked',
            'Date',
            'Mon, 21 May 2018 13:12:55 GMT',
            'Connection',
            'close',
            'Server',
            'AmazonS3',
      ...
      nock('https://s3.ap-northeast-1.amazonaws.com')
        ...
        .reply(200, '', [
          'x-amz-id-2',
          'svpKcyIH+XuAnlZIypbIbRnp6XNd6swNlKuFEV3soIRd2Imr+1nmnp2L4gcEbqP+eKU3MHUugdE=',
          'x-amz-request-id',
          '6E659346AF7425E4',
          'Date',
          'Sun, 21 Jan 2018 12:50:17 GMT',
          'ETag',
          '"ed168b6114db5f54d38bb1bd9ba45106"',
          'Content-Length',
          '0',
          'Server',
          'AmazonS3',
        ...
        .reply(200, { Body: fs.createReadStream(`${__dirname}/fixture/module.tar.gz`) }, [
          'x-amz-id-2',
          'UTXd/Ac9Lpf5htlqmY7jIa//st0VNw3HiV0H2tFpjQrabzdF0a1A0RXwaXXEDJsSMC0z9ieqSJg=',
          'x-amz-request-id',
          '51DCE049BC4189E5',
          'Date',
          'Sun, 21 Jan 2018 16:47:35 GMT',
          'Last-Modified',
          'Sun, 21 Jan 2018 16:47:35 GMT',
          'ETag',
          '"ed168b6114db5f54d38bb1bd9ba45106"',
        ...
        .reply(
          ...
          [
            ...
            'CA3688C9219019B8',
            'x-amz-id-2',
            'HoNack5lolKkIbPaGJADKOA1jLDxlP/G1gJMdi9Xc3j5WSaeHJphz/uqVLqDrMjA24W/8+kvJXM=',
            'Content-Type',
            'application/xml',
            'Transfer-Encoding',
            'chunked',
            'Date',
            'Sun, 21 Jan 2018 16:47:34 GMT',
            'Server',
            'AmazonS3',
          ]
        )
        ...
        .reply(204, '', [
          'x-amz-id-2',
          'S0/qBL0imAEhHXwySaB9UxDzA025VeonKZa7A4lP5LZgDC6jiYRhmb5gpRhbbOO6e+SkfvVSLh0=',
          'x-amz-request-id',
          'B9DB7B4B906399D7',
          'Date',
          'Sun, 21 Jan 2018 12:50:18 GMT',
          'Server',
          'AmazonS3',
        ]);
    }
