...
describe('GET /v1/modules', () => {
  before(async () => {
    await saveModule({
      namespace: 'GCP', name: 'lb-http', provider: 'google', version: '1.0.4', owner: '', source: '', description: '',
    });
    await saveModule({
...
describe('GET /v1/modules/:namespace', () => {
  before(async () => {
    ...
    await saveModule({
      namespace: 'aws-modules', name: 'vpc', provider: 'microsoft', version: '1.2.1', owner: '', source: '', description: '',
    });
    await saveModule({
      namespace: 'aws-modules', name: 'vpc', provider: 'microsoft', version: '1.5.0', owner: '', source: '', description: '',
    });
    await saveModule({
      namespace: 'aws-modules', name: 'vpc', provider: 'aws', version: '1.5.1', owner: '', source: '', description: '',
    });
...
describe('GET /v1/modules/:namespace/:name/:provider/versions', () => {
  before(async () => {
    await saveModule({
      namespace: 'GCP', name: 'lb-http', provider: 'google', version: '1.0.4', owner: '', source: '', description: '', definition: { root: { name: 'lb-http' }, submodules: [{ name: 'example' }] },
    });
    await saveModule({
      namespace: 'aws-modules', name: 'vpc', provider: 'aws', version: '1.2.1', owner: '', source: '', description: '', definition: { root: { name: 'vpc' }, submodules: [{ name: 'example' }] },
    });
    await saveModule({
      namespace: 'aws-modules', name: 'vpc', provider: 'aws', version: '1.5.0', owner: '', source: '', description: '', definition: { root: { name: 'vpc' }, submodules: [{ name: 'example' }] },
    });
    await saveModule({
      namespace: 'aws-modules', name: 'vpc', provider: 'aws', version: '1.5.1', owner: '', source: '', description: '', definition: { root: { name: 'vpc' }, submodules: [{ name: 'example' }] },
    });
  });
...
describe('GET /v1/modules/:namespace/:name', () => {
  before(async () => {
    await saveModule({
      namespace: 'hashicorp', name: 'consul', provider: 'azurerm', version: '0.1.0', owner: '', source: '', description: '',
    });
    await saveModule({
      namespace: 'hashicorp', name: 'consul', provider: 'azurerm', version: '0.2.0', owner: '', source: '', description: '',
    });
    await saveModule({
      namespace: 'hashicorp', name: 'consul', provider: 'aws', version: '1.1.1', owner: '', source: '', description: '',
    });
    await saveModule({
      namespace: 'hashicorp', name: 'consul', provider: 'aws', version: '1.1.2', owner: '', source: '', description: '',
    });
    await saveModule({
      namespace: 'hashicorp', name: 'consul', provider: 'google', version: '1.1.2', owner: '', source: '', description: '',
    });
  });
