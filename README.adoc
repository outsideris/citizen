...
and Run link:https://www.prisma.io/docs/reference/api-reference/command-reference#migrate-deploy[`prisma migrate deploy`] for Sqlite or
link:https://www.prisma.io/docs/reference/api-reference/command-reference#db-push[`prisma db push`] for MongoDB.
